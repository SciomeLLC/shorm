---
title: "SHARP Hormesis Detection"
author: "Ying Jin"
date: "`r Sys.Date()`"
output:
  html_document:
...
The p values from each repetition is stored in a data frame:
...
SharpScatter(RepPval$increase, RepPval$decrease, RepPval$convex, RepPval$concave, color = RepPval$readout, scale = T)
